...
describe('Service Tests', () => {
  describe('Car Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Car(0, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', currentDate, currentDate);
    });
    ...
    describe('Service methods', () => {
      it('should find an element', () => {
        const returnedFromService = Object.assign(
          {
            enteredTime: currentDate.format(DATE_TIME_FORMAT),
            leftTime: currentDate.format(DATE_TIME_FORMAT),
          },
          elemDefault
        );
      ...
      it('should create a Car', () => {
        ...
        const expected = Object.assign(
          {
            enteredTime: currentDate,
            leftTime: currentDate,
          },
          returnedFromService
        );
